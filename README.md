...
```bash
bitasmbl pull --repoUrl https://github.com/he1snber8/Bitasmbl_mydotnetbro_910_451 --appId 451 --repoId 309
```

## 3) Enter into the main directory and start coding!

```bash
cd Bitasmbl_mydotnetbro_910_451
```
...
{"Requirement":"Define task entity","Paths":["**/Models/**","**/Entities/**","**/Domain/**"]}
